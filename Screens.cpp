...
// Displays the battle screen showing both the users and computers characters and their health
...
// Displays the attack screen for the user to select a move for the current character
...
// Displays the target selection screen for the user to select an enemy target
...
// Displays the final win screen if the user wins the battle
...
// Displays the final loss screen if the user loses the battle
